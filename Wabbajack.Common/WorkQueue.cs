...
namespace Wabbajack.Common
{
    ...
    {
        internal IChannel<Func<Task>, Func<Task>> Queue = Channel.Create<Func<Task>>(1024);
        ...
        private void StartThreads(int threadCount)
        {
            ...
            Tasks = Enumerable.Range(1, threadCount).Select(ThreadBody).ToList();
        }
        ...
        public ValueTask<bool> QueueTask(Func<Task> a)
        {
            return Queue.Put(a);
        }
